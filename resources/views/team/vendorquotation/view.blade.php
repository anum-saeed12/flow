                            ...
                            <table class="table table-hover text-nowrap table-compact">
                                ...
                                @foreach($vendor_quotation as $quotation)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td><a href="{{ route('vendorquotation.view.team',$quotation->id) }}">{{ ucfirst($quotation->total) }}</a></td>
                                        ...
                                        <td class="text-right p-0">
                                            ...
                                            <a class="bg-primary list-btn"  href="{{ route('vendorquotation.edit.team',$quotation->id) }}"title="Edit"><i class="fas fa-tools" aria-hidden="false"></i></a>
