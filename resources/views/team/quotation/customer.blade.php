                            ...
                            <table class="table table-hover text-nowrap table-compact">
                                ...
                                @foreach($quotations as $quotation)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td><a href="{{ route('quotation.view.team',$quotation->id) }}">{{ ucfirst($quotation->item_description) }}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->id) }}">{{ ucfirst($quotation->total) }}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->id) }}">{{ ucfirst($quotation->name) }}</td>
