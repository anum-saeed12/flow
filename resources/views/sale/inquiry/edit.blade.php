            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="{{ route('inquiry.update.sale',$inquiry->id) }}" method="POST">
                            @csrf
                            <div class="card-body pb-0">
                                ...
                                <div class="row">
                                    <div class="col-md-2 category-container">
                                        ...
                                        <select name="category_id[]" class="form-control categories" id="category_id" data-target="#item_id" data-href="{{ route('category.fetch.ajax.sale') }}" data-spinner="#category_spinner" onchange="categorySelect($(this))">
                                            <option selected="selected" value>Select</option>
                                    ...
                                    <div class="col-md-2 item-container">
                                        ...
                                        <select name="item_id[]" class="form-control trigger" id="item_id" data-target="#brand_id" data-href="{{ route('item.fetch.ajax.sale') }}" data-spinner="#item_spinner" onchange="itemSelect($(this))">
                                            <option selected="selected" value>Select</option>
                                ...
                                <div class="additional-products">
                                    @foreach($inquiry->items as $inquiry_item)
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-2 category-container">
                                                <label for="category_id">Select Category</label><br/>
                                                <select name="category_id[]" class="form-control" id="category_id_{{ $loop->iteration }}" data-target="#item_id_{{ $loop->iteration }}" data-href="{{ route('category.fetch.ajax.sale') }}" data-spinner="#item_spinner_{{ $loop->iteration }}" onchange="categorySelect($(this))">
                                                    <option selected="selected" value>Select</option>
                                                    @foreach ($categories as $category)
                                            ...
                                            <div class="col-md-2 item-container">
                                                ...
                                                <select name="item_id[]" class="form-control" id="item_id_{{ $loop->iteration }}" data-target="#brand_id_{{ $loop->iteration }}" data-href="{{ route('item.fetch.ajax.sale') }}" data-spinner="#item_spinner_{{ $loop->iteration }}" onchange="itemSelect($(this))">
                                                    <option selected="selected" value>Select</option>
                                                    @foreach ($items as $item)
        ...
        $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                let $itemRow = '<div class="row mt-3 ">' +
                    '<div class="col-md-2 category-container">' +
                    '<label for="category_id">Select Category</label><br/>' +
                    `<select name="category_id[]" class="form-control categories" id="category_id_${$uid}" data-target="#item_id_${$uid}" data-href="{{ route('category.fetch.ajax.sale') }}" data-spinner="#category_spinner_${$uid}" onchange="categorySelect($(this))">` +
                    '<option selected="selected" value>Select</option>' +
                    @foreach ($categories as $category)
                    ...
                    '<div class="col-md-2 item-container">' +
                    '<label for="item_id">Select Item</label><br/>' +
                    `<select name="item_id[]" class="form-control " id="item_id_${$uid}" data-target="#brand_id_${$uid}" data-href="{{ route('item.fetch.ajax.sale') }}" data-spinner="#item_spinner_${$uid}" onchange="itemSelect($(this))">` +
                    '<option selected="selected" value>Select</option>' +
                    @foreach ($items as $item)
