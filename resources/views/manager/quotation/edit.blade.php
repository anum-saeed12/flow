            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="{{ route('quotation.update.manager',$quotation->id) }}" method="POST">
                            @csrf
                                    ...
                                    @foreach($quotation->items as $quotation_item)
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-3 item-container">
                                                ...
                                                <select name="item_id[]" class="form-control trigger" id="item_id_{{ $loop->iteration }}" data-target="#brand_id_{{ $loop->iteration }}" data-href="{{ route('item.fetch.ajax.manager') }}" data-spinner="#item_spinner_{{ $loop->iteration }}" onchange="itemSelect($(this))">
                                                    <option selected="selected" value>Select</option>
                                                    @foreach ($items as $item)
