...
<head>
    ...
    <!-- =======================================================
    * Template Name: {{ config('app.name') }} - v1.2.1
    * Template URL: https://bootstrapmade.com/{{ config('app.name') }}-bootstrap-business-template/
...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="index.html">OmniBiz<span>.</span></a></h1>
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="drop-down"><a href="">Members Area</a>
                    <ul>
    ...
    <section id="about" class="about section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <p>
                        ...
                        support.<br>Founded in 2020 and headquartered in Karachi, OmniBiz. is 100% founder owned and highly
                         profitable.
                    </p>
                </div>
            </div>
            <p>
                ...
                without having to spend a ton of money on multiple software's to automate their activities. Many businesses,
...
<footer id="footer">
    ...
    <div class="container py-4">
        ...
        <div class="credits">
            ...
            <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/OmniBiz-bootstrap-business-template/ -->
